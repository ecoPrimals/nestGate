...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MetricsHandlerConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TracingHandlerConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct HealthCheckHandlerConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct AlertingHandlerConfig { pub enabled: bool }
