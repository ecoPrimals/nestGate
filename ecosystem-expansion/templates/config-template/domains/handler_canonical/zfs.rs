...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PoolHandlerConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct DatasetHandlerConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct SnapshotHandlerConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct BackupHandlerConfig { pub enabled: bool }
