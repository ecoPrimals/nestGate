...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct AuthenticationHandlerConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct AuthorizationHandlerConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ThreatDetectionConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct AuditHandlerConfig { pub enabled: bool }
