...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ErrorResponseConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ErrorLoggingConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ErrorRecoveryConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ErrorNotificationConfig { pub enabled: bool }
