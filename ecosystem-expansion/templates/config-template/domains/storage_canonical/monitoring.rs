...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct MetricsStorageConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct AlertingStorageConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct LoggingStorageConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct HealthCheckStorageConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct DiagnosticsConfig { pub enabled: bool }
