...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct PerformanceOptimizationConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct IOOptimizationConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CompressionConfig { pub enabled: bool, pub algorithm: String }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct DeduplicationConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TuningConfig { pub auto_tune: bool }
...
impl Default for StoragePerformanceConfig {
    fn default() -> Self {
        Self {
            ...
            compression: CompressionConfig { enabled: true, algorithm: "lz4".to_string() },
