...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub enum CacheEvictionPolicy { Lru, Lfu, Fifo, Random }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CacheConsistencyConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CachePerformanceConfig { pub enabled: bool }

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CacheMonitoringConfig { pub enabled: bool }

impl Default for StorageCachingConfig {
    fn default() -> Self {
        Self {
            enabled: true,
            cache: CacheConfig { size: 1024 * 1024 * 1024, ttl: Duration::from_secs(3600) },
