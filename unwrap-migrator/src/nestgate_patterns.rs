...
//!
//! Custom patterns for migrating NestGate-specific unwrap/expect calls
//! to use proper error handling with the unified error system.

use crate::systematic_migrator::{MigrationPattern, ErrorCategory};
