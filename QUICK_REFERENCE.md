...
**Version**: 4.7.0-dev  
**Tests**: `cargo test --workspace --lib` — PASS, 0 failures (8,841 passing, 60 ignored — see STATUS.md)  
**Coverage**: 84.12%+ line (llvm-cov); target 90%  
**Clippy**: PASS — `cargo clippy --workspace --all-targets -- -D warnings` (as of Session 50)  
