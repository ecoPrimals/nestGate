...
**Current build status**: 22 workspace packages; 12,885 tests passed, 0 failures, 420 ignored; 84%+ line coverage; clippy clean with `-D warnings` — details in [STATUS.md](./STATUS.md).
