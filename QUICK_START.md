...
**Current build status**: 22 workspace packages; 3,790 tests passed, 73 ignored (1 pre-existing env-specific); 84%+ line coverage; clippy clean with `-D warnings` — details in [STATUS.md](./STATUS.md).
