...
**Current build status**: 18 workspace crates; 1,630+ tests passed, 0 failed (~80 ignored); clippy clean with `-D warnings` (pedantic+nursery) — details in [STATUS.md](./STATUS.md).
