...
**Current build status** (March 31, 2026): 24 workspace members; 8,376 lib tests passing, 0 failures; ~80% line coverage; clippy clean with `-D warnings` — details in [STATUS.md](./STATUS.md).
