...
**Current build status**: 22 workspace packages; 1,630 tests passed, 80 ignored (1,710 total; 1 pre-existing env-specific); 84%+ line coverage; clippy clean with `-D warnings` — details in [STATUS.md](./STATUS.md).
