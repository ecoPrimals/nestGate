...
**Current build status** (Session 84): 22 workspace packages; 682 RPC lib tests, 12,522+ full workspace, 0 failures; 84%+ line coverage; clippy clean with `-D warnings` — details in [STATUS.md](./STATUS.md).
