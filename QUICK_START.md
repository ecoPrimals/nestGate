...
**Current build status** (April 3, 2026): 24 workspace members; ~12,272 total tests passing, 0 failures; ~80% line coverage; clippy clean with `-D warnings` — details in [STATUS.md](./STATUS.md).
