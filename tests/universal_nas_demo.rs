...
async fn demonstrate_temporal_device_detection() {
    ...
    let simulated_devices = vec![
        ("📼 Punch Card Reader", "Prehistoric Era", "80 bytes", "Sequential"),
        ("💾 Floppy Drive", "Magnetic Era", "1.44 MB", "Direct Access"),
        ("💿 DVD Drive", "Optical Era", "4.7 GB", "Sequential Scan"),
        ("💽 NVMe SSD", "Digital Era", "1 TB", "Direct Access"),
        ("🧬 DNA Storage", "Biological Era", "1 TB/gram", "Biological Process"),
    ];
...
async fn demonstrate_ai_data_classification() {
    ...
    let data_classifications = vec![
        ("Human Genome Sequence", "🧬 Genome", "Hot Tier - Research Active"),
        ("GPT-4 Language Model", "🤖 AI Model", "Warm Tier - Inference Ready"),
        ("Satellite Imagery Dataset", "🛰️ Research Data", "Cold Tier - Archive Analysis"),
        ("1970s Punch Card Program", "📼 Legacy Code", "Archive Tier - Historical Preservation"),
        ("DNA Storage Sample", "🧬 Future Storage", "Quantum Tier - Experimental"),
    ];
