...
async fn test_e2e_scenario_54_metrics_collection() -> Result<()> {
    ...
    let metrics = vec![
        ("cpu.usage", 45.2, "%"),
        ("memory.used", 15.8, "GB"),
        ("disk.read_iops", 12500.0, "ops/s"),
        ("disk.write_iops", 8300.0, "ops/s"),
        ("network.rx_bytes", 125_000_000.0, "bytes/s"),
        ("network.tx_bytes", 98_000_000.0, "bytes/s"),
        ("app.requests", 15_234.0, "req/s"),
