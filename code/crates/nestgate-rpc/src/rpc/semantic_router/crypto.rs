...
pub(super) fn crypto_generate_key(
    _router: &SemanticRouter<impl MetadataBackend>,
    _params: Value,
) -> Result<Value> {
...
pub(super) fn crypto_generate_nonce(
    _router: &SemanticRouter<impl MetadataBackend>,
    _params: Value,
) -> Result<Value> {
...
pub(super) fn crypto_verify_hash(
    _router: &SemanticRouter<impl MetadataBackend>,
    _params: Value,
) -> Result<Value> {
