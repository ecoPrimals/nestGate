...
///
/// Unlike [`content_get`] which returns base64-encoded JSON, this returns
/// raw decrypted bytes and the content-type from the `.meta.json` sidecar,
/// suitable for `GET /content/:hash` with proper HTTP headers.
///
