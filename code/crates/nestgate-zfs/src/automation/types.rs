...
mod tests {
    ...
    fn test_lifecycle_rule_creation() {
        let rule = LifecycleRule {
            ...
            conditions: vec!["low_access".into()],
            actions: vec!["migrate".into()],
        };
    ...
    fn test_automation_event_creation() {
        let event = AutomationEvent {
            ...
            details: "Migrated to cold tier".into(),
            success: true,
        };
