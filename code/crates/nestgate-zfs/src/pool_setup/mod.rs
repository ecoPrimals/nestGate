...
mod pool_setup_unit_tests {
    ...
    fn recommend_pool_config_mixed_device_types_sets_tier_mappings() {
        ...
        assert!(
            cfg.tier_mappings
                .contains_key(&super::ConfigStorageTier::Hot)
        );
        assert!(
            cfg.tier_mappings
                .contains_key(&super::ConfigStorageTier::Warm)
        );
        assert!(
            cfg.tier_mappings
                .contains_key(&super::ConfigStorageTier::Cold)
        );
    }
    ...
    fn recommend_pool_config_single_device_type_replicates_across_tiers() {
        ...
        let hot = cfg
            .tier_mappings
            .get(&super::ConfigStorageTier::Hot)
            .expect("hot tier");
        let cold = cfg
            .tier_mappings
            .get(&super::ConfigStorageTier::Cold)
            .expect("cold tier");
        assert_eq!(hot, cold);
    }
