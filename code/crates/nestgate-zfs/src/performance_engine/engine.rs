...
#[cfg(test)]
impl PerformanceOptimizationEngine {
    pub(crate) async fn test_detect_bottlenecks(&self) -> Result<Vec<ZfsBottleneck>> {
...
mod engine_tests {
    use super::super::types::{
        AlertSeverity, AlertType, BottleneckSeverity, PerformanceAlert, ZfsBottleneckType,
        ZfsPerformanceMetrics, ZfsPoolMetrics,
    };
    ...
    fn optimization_state_default_is_idle() {
        use super::super::types::OptimizationState;
    ...
    fn performance_optimization_result_merge_combines() {
        use super::super::types::PerformanceOptimizationResult;
