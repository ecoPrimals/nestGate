...
/// - `NESTGATE_SOCKET_PATH`: Unix socket path (default: `temp_dir()/nestgate-{family}.sock`)
...
///     .with_socket_path("/run/user/1000/nestgate-nat0.sock")
...
mod tests {
    ...
    fn test_config_creation() {
        ...
        assert_eq!(
            config.socket_path,
            std::env::temp_dir().join("nestgate-nat0.sock")
        );
