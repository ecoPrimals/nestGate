...
//! # Infant Discovery Pattern Demo (archived)
//!
...
fn main() {
    eprintln!(
        "This example is archived — discovery APIs were evolved to nestgate-discovery crate."
    );
    eprintln!("See specs/INFANT_DISCOVERY_ARCHITECTURE_SPEC.md for the current pattern.");
}
