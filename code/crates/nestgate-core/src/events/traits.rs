...
/// ```rust
/// // OLD (deprecated):
/// use crate::network::config::EventsTraitsConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::EventsTraitsConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
...
impl Default for EventsTraitsConfig {
    fn default() -> Self {
        Self {
            enabled: true,
...
pub type Config = EventsTraitsConfig;
...
pub async fn validate_config(config: &EventsTraitsConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
pub type EventsTraitsConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using EventsTraitsConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = EventsTraitsConfig::default();
