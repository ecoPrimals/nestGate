...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::EventsTransformConfig;
///
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::EventsTransformConfig; // Now aliases to CanonicalNetworkConfig
/// ```
///
...
/// Configuration for EventsTransform
pub struct EventsTransformConfig {
...
impl Default for EventsTransformConfig {
...
pub type Config = EventsTransformConfig;
...
pub struct DefaultService {
    ...
    config: EventsTransformConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: EventsTransformConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    async fn initialize(&self) -> Result<()> {
        tracing::info!("Initializing transform service");
        Ok(())
    }
    ...
    async fn start(&self) -> Result<()> {
        tracing::info!("Starting transform service");
        Ok(())
    }

    /// Stop
    async fn stop(&self) -> Result<()> {
        tracing::info!("Stopping transform service");
        Ok(())
    }

    /// Shutdown
    async fn shutdown(&self) -> Result<()> {
        tracing::info!("Shutting down transform service");
        Ok(())
    }
}
...
pub async fn validate_config(config: &EventsTransformConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Eventstransformconfigcanonical
pub type EventsTransformConfigCanonical =
    crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using EventsTransformConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = EventsTransformConfig::default();
