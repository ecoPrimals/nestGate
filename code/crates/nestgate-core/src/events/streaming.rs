...
/// ```rust
/// // OLD (deprecated):
/// use crate::network::config::EventsStreamingConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::EventsStreamingConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
...
pub type Config = EventsStreamingConfig;
...
impl DefaultService {
    ...
    pub fn new(config: EventsStreamingConfig) -> Self {
        Self {
            config,
...
pub fn create_service() -> DefaultService {
    DefaultService::new(EventsStreamingConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &EventsStreamingConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
pub type EventsStreamingConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using EventsStreamingConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = EventsStreamingConfig::default();
