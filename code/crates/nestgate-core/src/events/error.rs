...
pub async fn validate_config(config: &EventsErrorConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
pub type EventsErrorConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;
