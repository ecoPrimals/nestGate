...
pub async fn validate_config(config: &EventsDlqConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
pub type EventsDlqConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;
