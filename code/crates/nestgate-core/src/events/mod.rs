...
#[allow(deprecated)]
pub type EventsMainConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;
...
pub async fn validate_config(config: &EventsMainConfig) -> crate::Result<()> {
