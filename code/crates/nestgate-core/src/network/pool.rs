...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::NetworkPoolConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::NetworkPoolConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
/// **Timeline**: This type alias will be maintained until v0.12.0 (May 2026)
#[deprecated(since = "0.11.0", note = "Use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig instead")]
/// Configuration for NetworkPool
...
impl DefaultService {
    ...
    pub fn new(config: NetworkPoolConfig) -> Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(pool));
// ==================== UTILITY FUNCTIONS ====================
/// Create a default service instance
pub fn create_service() -> DefaultService {
    DefaultService::new(NetworkPoolConfig::default())
/// Validate configuration
pub async fn validate_config(config: &NetworkPoolConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Networkpoolconfigcanonical
pub type NetworkPoolConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using NetworkPoolConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = NetworkPoolConfig::default();
