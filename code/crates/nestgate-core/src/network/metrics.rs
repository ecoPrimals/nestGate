...
// ==================== CORE TYPES ====================
/// Configuration for network metrics module
...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::NetworkMetricsConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::NetworkMetricsConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
/// **Timeline**: This type alias will be maintained until v0.12.0 (May 2026)
#[deprecated(since = "0.11.0", note = "Use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig instead")]
/// Configuration for NetworkMetrics
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(metrics));
// ==================== UTILITY FUNCTIONS ====================
/// Create a default service instance
pub fn create_service() -> DefaultService {
    DefaultService::new(NetworkMetricsConfig::default())
/// Validate configuration
pub async fn validate_config(config: &NetworkMetricsConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Networktracingconfigcanonical
...
/// The original struct is marked as deprecated but still functional.
#[allow(deprecated)]
/// Type alias for Networkmetricsconfigcanonical
...
mod tests {
    ...
    fn test_config_default() {
        let config = NetworkMetricsConfig::default();
        assert!(config.enabled);
        assert_eq!(config.max_connections, DEFAULT_MAX_CONNECTIONS);
    fn test_config_validation() {
        let mut config = NetworkMetricsConfig::default();
