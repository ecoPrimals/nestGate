...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::NetworkCircuitBreakerConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::NetworkCircuitBreakerConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
/// **Timeline**: This type alias will be maintained until v0.12.0 (May 2026)
#[deprecated(since = "0.11.0", note = "Use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig instead")]
/// Configuration for NetworkCircuitBreaker
...
impl Service for DefaultService {
    ...
    fn initialize(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Initializing {} service with config: {:?}", 
                      stringify!(circuit_breaker), config);
        Ok(())
    /// Health Check
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(circuit_breaker));
// ==================== UTILITY FUNCTIONS ====================
/// Create a default service instance
pub fn create_service() -> DefaultService {
    DefaultService::new(NetworkCircuitBreakerConfig::default())
/// Validate configuration
pub async fn validate_config(config: &NetworkCircuitBreakerConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Networkcircuitbreakerconfigcanonical
pub type NetworkCircuitBreakerConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using NetworkCircuitBreakerConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = NetworkCircuitBreakerConfig::default();
