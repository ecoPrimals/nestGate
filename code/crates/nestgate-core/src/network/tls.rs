...
// ==================== CORE TYPES ====================
/// Configuration for network tls module
#[derive(Debug, Clone, Serialize, Deserialize)]
/// Configuration for NetworkTls
...
impl DefaultService {
    ...
    pub fn new(config: NetworkTlsConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(tls));
        Ok(())
        }
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(NetworkTlsConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &NetworkTlsConfig) -> crate::Result<()> {
...
mod tests {
    ...
    fn test_config_default() {
        let config = NetworkTlsConfig::default();
    ...
    fn test_config_validation() {
        let mut config = NetworkTlsConfig::default();
