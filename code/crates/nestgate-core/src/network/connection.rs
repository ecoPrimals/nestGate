...
impl DefaultService {
    ...
    pub fn new(config: NetworkConnectionConfig) -> Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(connection));
// ==================== UTILITY FUNCTIONS ====================
/// Create a default service instance
pub fn create_service() -> DefaultService {
    DefaultService::new(NetworkConnectionConfig::default())
/// Validate configuration
pub async fn validate_config(config: &NetworkConnectionConfig) -> crate::Result<()> {
...
mod tests {
    ...
    fn test_config_default() {
        let config = NetworkConnectionConfig::default();
