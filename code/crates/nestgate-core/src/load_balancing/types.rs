...
/// Configuration for LoadBalancingTypes
pub struct LoadBalancingTypesConfig {
...
impl Default for LoadBalancingTypesConfig {
...
pub struct DefaultService {
    config: LoadBalancingTypesConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: LoadBalancingTypesConfig) -> Self {
        Self {
            config,
...
pub fn create_service() -> DefaultService {
    DefaultService::new(LoadBalancingTypesConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &LoadBalancingTypesConfig) -> crate::Result<()> {
...
mod tests {
    ...
    fn test_config_default() {
        let config = LoadBalancingTypesConfig::default();
