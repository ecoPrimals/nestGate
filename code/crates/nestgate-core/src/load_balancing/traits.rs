...
/// Configuration for LoadBalancingTraits
pub struct LoadBalancingTraitsConfig {
...
impl Default for LoadBalancingTraitsConfig {
...
pub struct DefaultService {
    config: LoadBalancingTraitsConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: LoadBalancingTraitsConfig) -> Self {
        Self {
            config,
...
pub fn create_service() -> DefaultService {
    DefaultService::new(LoadBalancingTraitsConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &LoadBalancingTraitsConfig) -> crate::Result<()> {
    if config.max_connections == 0 {
        return Err(NestGateError::configuration_error(
            "load_balancing_traits",
...
mod tests {
    ...
    fn test_config_default() {
        let config = LoadBalancingTraitsConfig::default();
