...
/// Configuration for LoadBalancingModule
pub struct LoadBalancingModuleConfig {
...
impl Default for LoadBalancingModuleConfig {
...
impl DefaultService {
    ...
    pub fn new(config: LoadBalancingModuleConfig) -> Self {
        Self {
            config,
...
pub fn create_service() -> DefaultService {
    DefaultService::new(LoadBalancingModuleConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &LoadBalancingModuleConfig) -> crate::Result<()> {
...
mod tests {
    ...
    fn test_config_default() {
        let config = LoadBalancingModuleConfig::default();
