...
/// ```rust
/// // OLD (deprecated):
/// use crate::config::PerfMonitorConfig;
/// 
/// // NEW (canonical):
/// use crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::config::PerfMonitorConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(perf_monitor));
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(PerfMonitorConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &PerfMonitorConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Perfmonitorconfigcanonical
pub type PerfMonitorConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using PerfMonitorConfig (the deprecated struct) for now.
