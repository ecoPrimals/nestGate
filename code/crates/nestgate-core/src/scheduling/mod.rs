...
/// Configuration for SchedulingModule
pub struct SchedulingModuleConfig {
...
impl Default for SchedulingModuleConfig {
...
pub struct DefaultService {
    config: SchedulingModuleConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: SchedulingModuleConfig) -> Self {
        Self {
            config,
...
pub fn create_service() -> DefaultService {
    DefaultService::new(SchedulingModuleConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &SchedulingModuleConfig) -> crate::Result<()> {
...
mod tests {
    ...
    fn test_config_default() {
        let config = SchedulingModuleConfig::default();
