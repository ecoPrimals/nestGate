...
mod tests {
    ...
    fn test_timeout_ms_default() {
        let _guard = EnvGuard::new("NESTGATE_TIMEOUT_MS", "");
    ...
    fn test_max_connections_default() {
        let _guard = EnvGuard::new("NESTGATE_MAX_CONNECTIONS", "");
    ...
    fn test_buffer_size_default() {
        let _guard = EnvGuard::new("NESTGATE_BUFFER_SIZE", "");
    ...
    fn test_default_retry_attempts_default() {
        let _guard = EnvGuard::new("NESTGATE_RETRY_ATTEMPTS", "");
