...
/// Configuration for ConstantsSecurity
pub struct ConstantsSecurityConfig {
...
impl Default for ConstantsSecurityConfig {
...
pub struct DefaultService {
    config: ConstantsSecurityConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: ConstantsSecurityConfig) -> Self {
        Self {
            config,
...
pub fn create_service() -> DefaultService {
    DefaultService::new(ConstantsSecurityConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &ConstantsSecurityConfig) -> crate::Result<()> {
...
mod tests {
    ...
    fn test_config_default() {
        let config = ConstantsSecurityConfig::default();
