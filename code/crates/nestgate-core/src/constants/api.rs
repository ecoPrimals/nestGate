...
/// Configuration for ConstantsApi
pub struct ConstantsApiConfig {
...
impl Default for ConstantsApiConfig {
...
pub struct DefaultService {
    config: ConstantsApiConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: ConstantsApiConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(api));
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(ConstantsApiConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &ConstantsApiConfig) -> crate::Result<()> {
...
mod tests {
    ...
    fn test_config_default() {
        let config = ConstantsApiConfig::default();
