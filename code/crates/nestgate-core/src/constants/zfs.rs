...
/// Configuration for ConstantsZfs
pub struct ConstantsZfsConfig {
...
impl Default for ConstantsZfsConfig {
...
pub struct DefaultService {
    config: ConstantsZfsConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: ConstantsZfsConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(zfs));
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(ConstantsZfsConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &ConstantsZfsConfig) -> crate::Result<()> {
...
mod tests {
    ...
    fn test_config_default() {
        let config = ConstantsZfsConfig::default();
    ...
    async fn test_service_creation() {
        ...
        assert_eq!(service.health_check().await.expect("ZFS operation failed"), HealthStatus::Healthy);
