...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::MonitoringMonitorConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::MonitoringMonitorConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
/// **Timeline**: This type alias will be maintained until v0.12.0 (May 2026)
#[deprecated(since = "0.11.0", note = "Use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig instead")]
/// Configuration for MonitoringMonitor
pub struct MonitoringMonitorConfig {
...
impl Default for MonitoringMonitorConfig {
...
pub struct DefaultService {
    config: MonitoringMonitorConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: MonitoringMonitorConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(monitor));
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(MonitoringMonitorConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &MonitoringMonitorConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Monitoringmonitorconfigcanonical
pub type MonitoringMonitorConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using MonitoringMonitorConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = MonitoringMonitorConfig::default();
