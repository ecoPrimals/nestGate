...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::MonitoringErrorConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::MonitoringErrorConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
/// **Timeline**: This type alias will be maintained until v0.12.0 (May 2026)
#[deprecated(since = "0.11.0", note = "Use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig instead")]
/// Configuration for MonitoringError
...
#[allow(deprecated)]
/// Type alias for Monitoringerrorconfigcanonical
pub type MonitoringErrorConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using MonitoringErrorConfig (the deprecated struct) for now.
