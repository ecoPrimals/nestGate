...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::MonitoringTraitsConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::MonitoringTraitsConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
/// **Timeline**: This type alias will be maintained until v0.12.0 (May 2026)
#[deprecated(since = "0.11.0", note = "Use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig instead")]
/// Configuration for MonitoringTraits
pub struct MonitoringTraitsConfig {
...
impl Default for MonitoringTraitsConfig {
...
pub struct DefaultService {
    config: MonitoringTraitsConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: MonitoringTraitsConfig) -> Self {
        Self {
            config,
...
pub fn create_service() -> DefaultService {
    DefaultService::new(MonitoringTraitsConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &MonitoringTraitsConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Monitoringtraitsconfigcanonical
pub type MonitoringTraitsConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using MonitoringTraitsConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = MonitoringTraitsConfig::default();
