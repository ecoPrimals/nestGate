...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::MonitoringSystemConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::MonitoringSystemConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
...
impl DefaultService {
    ...
    pub fn new(config: MonitoringSystemConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(system));
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(MonitoringSystemConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &MonitoringSystemConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Monitoringsystemconfigcanonical
pub type MonitoringSystemConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using MonitoringSystemConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = MonitoringSystemConfig::default();
