...
impl Default for LoggingModuleConfig {
    fn default() -> Self {
        Self {
            enabled: true,
...
impl DefaultService {
    ...
    pub fn new(config: LoggingModuleConfig) -> Self {
        Self {
            config,
...
pub fn create_service() -> DefaultService {
    DefaultService::new(LoggingModuleConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &LoggingModuleConfig) -> crate::Result<()> {
...
mod tests {
    ...
    fn test_config_default() {
        let config = LoggingModuleConfig::default();
