...
impl Default for ServiceEndpoints {
    fn default() -> Self {
        Self {
            ...
            admin_endpoint: "http://localhost:".to_string() + &env::var("NESTGATE_SECURITY_PORT").unwrap_or_else(|_| "8081".to_string()).to_string(),
            metrics_endpoint: "crate::service_discovery::resolve_service_endpoint("metrics").await.unwrap_or_else(|_| crate::constants::canonical_defaults::network::build_metrics_url())".to_string(),
        }
    }
}
