...
mod config_error_path_comprehensive_tests {
    ...
    fn test_port_discovery_with_invalid_env_uses_default() {
        ...
        env::set_var("NESTGATE_TEST_PORT_INVALID", "invalid");
        ...
        // Cleanup
        env::remove_var("NESTGATE_TEST_PORT_INVALID");
    }

    #[test]
    fn test_port_discovery_with_zero_uses_default() {
        env::set_var("NESTGATE_TEST_PORT_ZERO", "0");
        ...
        // Cleanup
        env::remove_var("NESTGATE_TEST_PORT_ZERO");
    }
    ...
    fn test_multiple_invalid_env_vars_chain() {
        ...
        env::set_var("NESTGATE_TEST_PORT_1", "invalid1");
        env::set_var("NESTGATE_TEST_PORT_2", "invalid2");
        env::set_var("NESTGATE_TEST_PORT_3", "invalid3");
        ...
        // Cleanup
        env::remove_var("NESTGATE_TEST_PORT_1");
        env::remove_var("NESTGATE_TEST_PORT_2");
        env::remove_var("NESTGATE_TEST_PORT_3");
    }
...
mod config_capability_discovery_error_tests {
    ...
    fn test_runtime_discovery_fallback_chain() {
        ...
        env::set_var("NESTGATE_TEST_RUNTIME_PORT", "9000");
        ...
        // Cleanup
        env::remove_var("NESTGATE_TEST_RUNTIME_PORT");
    }
}
