...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::MemoryOptimizationPoolsConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::MemoryOptimizationPoolsConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
/// **Timeline**: This type alias will be maintained until v0.12.0 (May 2026)
#[deprecated(since = "0.11.0", note = "Use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig instead")]
/// Configuration for MemoryOptimizationPools
pub struct MemoryOptimizationPoolsConfig {
...
impl Default for MemoryOptimizationPoolsConfig {
...
pub struct DefaultService {
    config: MemoryOptimizationPoolsConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: MemoryOptimizationPoolsConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(pools));
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(MemoryOptimizationPoolsConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &MemoryOptimizationPoolsConfig) -> crate::Result<()> {
    if config.max_connections == 0 {
        return Err(NestGateError::configuration_error(
            "memory_optimization_pools",
...
#[allow(deprecated)]
/// Type alias for Memoryoptimizationpoolsconfigcanonical
pub type MemoryOptimizationPoolsConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using MemoryOptimizationPoolsConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = MemoryOptimizationPoolsConfig::default();
