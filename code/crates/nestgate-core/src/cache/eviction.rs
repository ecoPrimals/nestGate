...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::CacheEvictionConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::CacheEvictionConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
/// **Timeline**: This type alias will be maintained until v0.12.0 (May 2026)
#[deprecated(since = "0.11.0", note = "Use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig instead")]
/// Configuration for CacheEviction
...
impl DefaultService {
    ...
    pub fn new(config: CacheEvictionConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(eviction));
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(CacheEvictionConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &CacheEvictionConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Cacheevictionconfigcanonical
pub type CacheEvictionConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using CacheEvictionConfig (the deprecated struct) for now.
