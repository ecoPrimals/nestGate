...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::CacheAlgorithmsConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::CacheAlgorithmsConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
/// **Timeline**: This type alias will be maintained until v0.12.0 (May 2026)
#[deprecated(since = "0.11.0", note = "Use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig instead")]
/// Configuration for CacheAlgorithms
pub struct CacheAlgorithmsConfig {
...
impl Default for CacheAlgorithmsConfig {
...
pub struct DefaultService {
    config: CacheAlgorithmsConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: CacheAlgorithmsConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(algorithms));
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(CacheAlgorithmsConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &CacheAlgorithmsConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Cachealgorithmsconfigcanonical
pub type CacheAlgorithmsConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using CacheAlgorithmsConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = CacheAlgorithmsConfig::default();
