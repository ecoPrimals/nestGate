...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::CacheCompressionConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::CacheCompressionConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
/// **Timeline**: This type alias will be maintained until v0.12.0 (May 2026)
#[deprecated(since = "0.11.0", note = "Use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig instead")]
/// Configuration for CacheCompression
...
impl DefaultService {
    ...
    pub fn new(config: CacheCompressionConfig) -> Self {
        Self {
            config,
...
pub fn create_service() -> DefaultService {
    DefaultService::new(CacheCompressionConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &CacheCompressionConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Cachecompressionconfigcanonical
pub type CacheCompressionConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using CacheCompressionConfig (the deprecated struct) for now.
