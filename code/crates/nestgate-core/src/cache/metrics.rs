...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::CacheMetricsConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::CacheMetricsConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
/// **Timeline**: This type alias will be maintained until v0.12.0 (May 2026)
#[deprecated(since = "0.11.0", note = "Use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig instead")]
/// Configuration for CacheMetrics
...
pub fn create_service() -> DefaultService {
    DefaultService::new(CacheMetricsConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &CacheMetricsConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Cachemetricsconfigcanonical
pub type CacheMetricsConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using CacheMetricsConfig (the deprecated struct) for now.
