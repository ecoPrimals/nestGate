...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::CacheReplicationConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::CacheReplicationConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
...
/// **Timeline**: This type alias will be maintained until v0.12.0 (May 2026)
#[deprecated(since = "0.11.0", note = "Use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig instead")]
/// Configuration for CacheReplication
...
pub struct DefaultService {
    config: CacheReplicationConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: CacheReplicationConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(replication));
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(CacheReplicationConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &CacheReplicationConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Cachereplicationconfigcanonical
pub type CacheReplicationConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using CacheReplicationConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = CacheReplicationConfig::default();
