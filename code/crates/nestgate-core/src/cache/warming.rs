...
/// ```rust
/// // OLD (deprecated):
/// use crate::network::config::CacheWarmingConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::CacheWarmingConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
