...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::CacheConsistencyConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::CacheConsistencyConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
...
impl Default for CacheConsistencyConfig {
...
impl DefaultService {
    ...
    pub fn new(config: CacheConsistencyConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(consistency));
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(CacheConsistencyConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &CacheConsistencyConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Cacheconsistencyconfigcanonical
pub type CacheConsistencyConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using CacheConsistencyConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = CacheConsistencyConfig::default();
