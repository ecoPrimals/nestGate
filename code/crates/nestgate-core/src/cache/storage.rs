...
/// use crate::network::config::CacheStorageConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
/// **Timeline**: This type alias will be maintained until v0.12.0 (May 2026)
#[deprecated(since = "0.11.0", note = "Use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig instead")]
/// Configuration for CacheStorage
...
impl DefaultService {
    ...
    pub fn new(config: CacheStorageConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(storage));
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(CacheStorageConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &CacheStorageConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Cachestorageconfigcanonical
pub type CacheStorageConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using CacheStorageConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = CacheStorageConfig::default();
    ...
    async fn test_service_creation() {
        ...
        assert_eq!(service.health_check().await.expect("Storage operation failed"), HealthStatus::Healthy);
