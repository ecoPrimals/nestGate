...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::CacheModuleConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::CacheModuleConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
...
impl DefaultService {
    ...
    pub fn new(config: CacheModuleConfig) -> Self {
        Self {
            config,
...
pub fn create_service() -> DefaultService {
    DefaultService::new(CacheModuleConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &CacheModuleConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Cachemoduleconfigcanonical
pub type CacheModuleConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using CacheModuleConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = CacheModuleConfig::default();
