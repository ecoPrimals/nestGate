...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::CacheErrorConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::CacheErrorConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
/// **Timeline**: This type alias will be maintained until v0.12.0 (May 2026)
#[deprecated(since = "0.11.0", note = "Use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig instead")]
/// Configuration for CacheError
pub struct CacheErrorConfig {
...
impl Default for CacheErrorConfig {
...
pub struct DefaultService {
    config: CacheErrorConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: CacheErrorConfig) -> Self {
        Self {
            config,
...
pub fn create_service() -> DefaultService {
    DefaultService::new(CacheErrorConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &CacheErrorConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Cacheerrorconfigcanonical
pub type CacheErrorConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using CacheErrorConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = CacheErrorConfig::default();
