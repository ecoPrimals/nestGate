...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::CacheLoaderConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::CacheLoaderConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
/// **Timeline**: This type alias will be maintained until v0.12.0 (May 2026)
#[deprecated(since = "0.11.0", note = "Use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig instead")]
/// Configuration for CacheLoader
pub struct CacheLoaderConfig {
...
impl Default for CacheLoaderConfig {
...
impl DefaultService {
    ...
    pub fn new(config: CacheLoaderConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(loader));
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(CacheLoaderConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &CacheLoaderConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Cacheloaderconfigcanonical
pub type CacheLoaderConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using CacheLoaderConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = CacheLoaderConfig::default();
