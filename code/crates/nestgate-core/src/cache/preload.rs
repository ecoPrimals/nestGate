...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::CachePreloadConfig;
/// 
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::CachePreloadConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
/// **Timeline**: This type alias will be maintained until v0.12.0 (May 2026)
#[deprecated(since = "0.11.0", note = "Use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig instead")]
/// Configuration for CachePreload
pub struct CachePreloadConfig {
...
impl Default for CachePreloadConfig {
...
impl DefaultService {
    ...
    pub fn new(config: CachePreloadConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(preload));
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(CachePreloadConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &CachePreloadConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Cachepreloadconfigcanonical
pub type CachePreloadConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using CachePreloadConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = CachePreloadConfig::default();
