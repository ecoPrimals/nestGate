...
mod tests {
    ...
    #[tokio::test]
    async fn test_security_capability_validation() {
    ...
    #[test]
    fn test_universal_security_error_display() {
    ...
    fn test_security_service_node_creation() {
        ...
        assert!(node.capabilities.contains(&"encryption".to_string()));
    ...
    #[test]
    fn test_security_error_std_error_trait() {
    ...
    #[test]
    fn test_security_capability_debug() {
        let capability = UniversalSecurityCapability {
