...
pub mod authentication; // Hybrid: external BearDog + local token validation
                        ...
                        // pub mod signing;         // Hybrid: external BearDog + local signature verification
...
// These will route to BearDog when available, fall back to local smart implementations
pub use authentication::{
    AuthTokenManager,
    AuthenticationConfig,
    HybridAuthenticationManager, // Routes to BearDog, falls back to local token validation
};
// pub use encryption::{
//     HybridEncryptionManager,        // Routes to BearDog, falls back to local AES encryption
//     EncryptionAlgorithm, EncryptionConfig,
// };
// pub use signing::{
//     HybridSigningManager,           // Routes to BearDog, falls back to local signature verification
