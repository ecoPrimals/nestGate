...
/// Configuration for ZeroCostSecurityProviderProduction
pub struct ZeroCostSecurityProviderProductionConfig {
...
impl Default for ZeroCostSecurityProviderProductionConfig {
...
pub struct DefaultService {
    config: ZeroCostSecurityProviderProductionConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: ZeroCostSecurityProviderProductionConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(production));
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(ZeroCostSecurityProviderProductionConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &ZeroCostSecurityProviderProductionConfig) -> crate::Result<()> {
...
mod tests {
    ...
    fn test_config_default() {
        let config = ZeroCostSecurityProviderProductionConfig::default();
    ...
    async fn test_service_creation() {
        ...
        assert_eq!(service.health_check().await.expect("Security operation failed"), HealthStatus::Healthy);
