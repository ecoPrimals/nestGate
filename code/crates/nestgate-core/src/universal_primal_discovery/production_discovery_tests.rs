...
fn test_discover_port_from_env() {
    ...
    match orig {
        Some(v) => env::set_var("NESTGATE_TEST_SERVICE_PORT", v),
        None => env::remove_var("NESTGATE_TEST_SERVICE_PORT"),
    }
    assert!(result.is_ok());
}
...
fn test_discover_port_invalid_env() {
    ...
    match orig {
        Some(v) => env::set_var("NESTGATE_INVALID_PORT", v),
        None => env::remove_var("NESTGATE_INVALID_PORT"),
    }
    assert!(result.is_ok());
}
...
fn test_discover_port_out_of_range() {
    ...
    match orig {
        Some(v) => env::set_var("NESTGATE_OOR_PORT", v),
        None => env::remove_var("NESTGATE_OOR_PORT"),
    }
    assert!(result.is_ok());
}
...
fn test_discover_bind_address_from_env() {
    ...
    match orig {
        Some(v) => env::set_var("NESTGATE_API_HOST", v),
        None => env::remove_var("NESTGATE_API_HOST"),
    }
    assert!(result.is_ok());
}
...
fn test_discover_bind_address_invalid_ip() {
    ...
    match orig {
        Some(v) => env::set_var("NESTGATE_INVALID_HOST", v),
        None => env::remove_var("NESTGATE_INVALID_HOST"),
    }
    assert!(result.is_ok());
}
...
fn test_discover_endpoint_success() {
    ...
    match orig_host {
        Some(v) => env::set_var("NESTGATE_WEB_HOST", v),
        None => env::remove_var("NESTGATE_WEB_HOST"),
    }
    match orig_port {
        Some(v) => env::set_var("NESTGATE_WEB_PORT", v),
        None => env::remove_var("NESTGATE_WEB_PORT"),
    }
    assert!(result.is_ok());
...
fn test_discover_endpoint_partial_config() {
    ...
    match orig {
        Some(v) => env::set_var("NESTGATE_PARTIAL_PORT", v),
        None => env::remove_var("NESTGATE_PARTIAL_PORT"),
    }
    assert!(result.is_ok());
    let socket_addr = result.unwrap();
...
fn test_discover_timeout_from_env() {
    ...
    match orig {
        Some(v) => env::set_var("NESTGATE_TIMEOUT_CONNECT_MS", v),
        None => env::remove_var("NESTGATE_TIMEOUT_CONNECT_MS"),
    }
    assert!(result.is_ok());
}
...
fn test_discover_timeout_invalid() {
    ...
    match orig {
        Some(v) => env::set_var("NESTGATE_TIMEOUT_INVALID_MS", v),
        None => env::remove_var("NESTGATE_TIMEOUT_INVALID_MS"),
    }
    assert!(result.is_ok());
}
...
fn test_discover_ipv4_address() {
    ...
    match orig {
        Some(v) => env::set_var("NESTGATE_IPV4_HOST", v),
        None => env::remove_var("NESTGATE_IPV4_HOST"),
    }
    assert!(result.is_ok());
    let addr = result.unwrap();
    assert!(addr.is_ipv4());
...
fn test_discover_ipv6_address() {
    ...
    match orig {
        Some(v) => env::set_var("NESTGATE_IPV6_HOST", v),
        None => env::remove_var("NESTGATE_IPV6_HOST"),
    }
    if result.is_ok() {
        let addr = result.unwrap();
        assert!(addr.is_ipv6());
...
fn test_graceful_error_handling() {
    ...
    match orig1 {
        Some(v) => env::set_var("NESTGATE_INVALID1_PORT", v),
        None => env::remove_var("NESTGATE_INVALID1_PORT"),
    }
    match orig2 {
        Some(v) => env::set_var("NESTGATE_INVALID2_HOST", v),
        None => env::remove_var("NESTGATE_INVALID2_HOST"),
    }
    match orig3 {
        Some(v) => env::set_var("NESTGATE_INVALID3_TIMEOUT_MS", v),
        None => env::remove_var("NESTGATE_INVALID3_TIMEOUT_MS"),
    }
    assert!(discovery.is_ok());
}
