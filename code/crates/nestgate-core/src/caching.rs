...
/// ```rust
/// // OLD (deprecated):
/// use crate::config::CachingModuleConfig;
/// 
/// // NEW (canonical):
/// use crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::config::CachingModuleConfig; // Now aliases to CanonicalNetworkConfig
/// ```
/// 
...
/// Configuration for CachingModule
pub struct CachingModuleConfig {
...
impl Default for CachingModuleConfig {
...
pub struct DefaultService {
    config: CachingModuleConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: CachingModuleConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(caching));
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(CachingModuleConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &CachingModuleConfig) -> crate::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Cachingmoduleconfigcanonical
pub type CachingModuleConfigCanonical = crate::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using CachingModuleConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = CachingModuleConfig::default();
