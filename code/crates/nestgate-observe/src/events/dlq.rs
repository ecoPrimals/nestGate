...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::EventsDlqConfig;
///
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::EventsDlqConfig; // Now aliases to CanonicalNetworkConfig
/// ```
///
...
/// Configuration for `EventsDlq`
pub struct EventsDlqConfig {
...
impl Default for EventsDlqConfig {
...
pub type Config = EventsDlqConfig;
...
impl DefaultService {
    ...
    #[must_use]
    pub fn new(config: EventsDlqConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    async fn initialize(&self) -> Result<()> {
        tracing::info!("Initializing dlq service");
        Ok(())
    }

    /// Start
    async fn start(&self) -> Result<()> {
        tracing::info!("Starting dlq service");
        Ok(())
    }

    /// Stop
    async fn stop(&self) -> Result<()> {
        tracing::info!("Stopping dlq service");
        Ok(())
    }
...
pub fn create_service() -> DefaultService {
    DefaultService::new(EventsDlqConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &EventsDlqConfig) -> nestgate_types::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Eventsdlqconfigcanonical
pub type EventsDlqConfigCanonical =
    nestgate_config::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using EventsDlqConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = EventsDlqConfig::default();
