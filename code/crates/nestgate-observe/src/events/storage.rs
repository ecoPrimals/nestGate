...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::EventsStorageConfig;
///
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::EventsStorageConfig; // Now aliases to CanonicalNetworkConfig
/// ```
///
...
/// Configuration for EventsStorage
pub struct EventsStorageConfig {
...
impl Default for EventsStorageConfig {
...
pub type Config = EventsStorageConfig;
...
pub struct DefaultService {
    ...
    config: EventsStorageConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: EventsStorageConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    async fn shutdown(&self) -> Result<()> {
        tracing::info!("Shutting down storage service");
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(EventsStorageConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &EventsStorageConfig) -> nestgate_types::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Eventsstorageconfigcanonical
pub type EventsStorageConfigCanonical =
    nestgate_config::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using EventsStorageConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = EventsStorageConfig::default();
