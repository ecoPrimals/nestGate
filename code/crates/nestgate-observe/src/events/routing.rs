...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::EventsRoutingConfig;
///
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::EventsRoutingConfig; // Now aliases to CanonicalNetworkConfig
/// ```
///
...
/// Configuration for EventsRouting
pub struct EventsRoutingConfig {
...
impl Default for EventsRoutingConfig {
...
pub type Config = EventsRoutingConfig;
...
pub struct DefaultService {
    ...
    config: EventsRoutingConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: EventsRoutingConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    async fn initialize(&self) -> Result<()> {
        tracing::info!("Initializing routing service");
        Ok(())
    }
    ...
    async fn start(&self) -> Result<()> {
        tracing::info!("Starting routing service");
        Ok(())
    }

    /// Stop
    async fn stop(&self) -> Result<()> {
        tracing::info!("Stopping routing service");
        Ok(())
    }

    /// Shutdown
    async fn shutdown(&self) -> Result<()> {
        tracing::info!("Shutting down routing service");
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(EventsRoutingConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &EventsRoutingConfig) -> nestgate_types::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Eventsroutingconfigcanonical
pub type EventsRoutingConfigCanonical =
    nestgate_config::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using EventsRoutingConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = EventsRoutingConfig::default();
