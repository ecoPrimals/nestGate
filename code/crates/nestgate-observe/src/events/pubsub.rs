...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::EventsPubsubConfig;
///
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::EventsPubsubConfig; // Now aliases to CanonicalNetworkConfig
/// ```
///
...
/// Configuration for `EventsPubsub`
pub struct EventsPubsubConfig {
...
impl Default for EventsPubsubConfig {
...
pub type Config = EventsPubsubConfig;
...
impl DefaultService {
    ...
    #[must_use]
    pub fn new(config: EventsPubsubConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    async fn initialize(&self) -> Result<()> {
        tracing::info!("Initializing pubsub service");
        Ok(())
    }

    /// Start
    async fn start(&self) -> Result<()> {
        tracing::info!("Starting pubsub service");
        Ok(())
    }

    /// Stop
    async fn stop(&self) -> Result<()> {
        tracing::info!("Stopping pubsub service");
        Ok(())
    }
...
pub fn create_service() -> DefaultService {
    DefaultService::new(EventsPubsubConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &EventsPubsubConfig) -> nestgate_types::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Eventspubsubconfigcanonical
pub type EventsPubsubConfigCanonical =
    nestgate_config::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using EventsPubsubConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = EventsPubsubConfig::default();
