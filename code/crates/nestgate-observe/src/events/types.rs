...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::EventsTypesConfig;
///
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::EventsTypesConfig; // Now aliases to CanonicalNetworkConfig
/// ```
///
...
/// Configuration for `EventsTypes`
pub struct EventsTypesConfig {
...
impl Default for EventsTypesConfig {
...
pub type Config = EventsTypesConfig;
...
impl DefaultService {
    ...
    #[must_use]
    pub fn new(config: EventsTypesConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    async fn initialize(&self) -> Result<()> {
        tracing::info!("Initializing types service");
        Ok(())
    }
    ...
    async fn start(&self) -> Result<()> {
        tracing::info!("Starting types service");
        Ok(())
    }

    /// Stop
    async fn stop(&self) -> Result<()> {
        tracing::info!("Stopping types service");
        Ok(())
    }

    /// Shutdown
    async fn shutdown(&self) -> Result<()> {
        tracing::info!("Shutting down types service");
        Ok(())
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(EventsTypesConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &EventsTypesConfig) -> nestgate_types::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Eventstypesconfigcanonical
pub type EventsTypesConfigCanonical =
    nestgate_config::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using EventsTypesConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = EventsTypesConfig::default();
