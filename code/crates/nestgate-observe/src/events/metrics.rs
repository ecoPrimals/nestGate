...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::EventsMetricsConfig;
///
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::EventsMetricsConfig; // Now aliases to CanonicalNetworkConfig
/// ```
///
...
/// Configuration for EventsMetrics
pub struct EventsMetricsConfig {
...
impl Default for EventsMetricsConfig {
...
pub type Config = EventsMetricsConfig;
...
pub struct DefaultService {
    ...
    config: EventsMetricsConfig,
    metrics: Arc<tokio::sync::RwLock<Metrics>>,
}

impl DefaultService {
    /// Create a new service instance
    pub fn new(config: EventsMetricsConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    async fn stop(&self) -> Result<()> {
        tracing::info!("Stopping metrics service");
        Ok(())
    }
...
pub fn create_service() -> DefaultService {
    DefaultService::new(EventsMetricsConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &EventsMetricsConfig) -> nestgate_types::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Eventsmetricsconfigcanonical
pub type EventsMetricsConfigCanonical =
    nestgate_config::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using EventsMetricsConfig (the deprecated struct) for now.
...
mod tests {
    ...
    fn test_config_default() {
        let config = EventsMetricsConfig::default();
