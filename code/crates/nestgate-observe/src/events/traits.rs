...
pub async fn validate_config(config: &EventsTraitsConfig) -> nestgate_types::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Eventstraitsconfigcanonical
pub type EventsTraitsConfigCanonical =
