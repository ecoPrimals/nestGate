...
/// ```rust,ignore
/// // OLD (deprecated):
/// use crate::network::config::EventsBusConfig;
///
/// // NEW (canonical):
/// use nestgate_core::config::canonical_primary::domains::network::CanonicalNetworkConfig;
/// // Or use type alias for compatibility:
/// use crate::network::config::EventsBusConfig; // Now aliases to CanonicalNetworkConfig
/// ```
///
...
pub async fn validate_config(config: &EventsBusConfig) -> nestgate_types::Result<()> {
...
#[allow(deprecated)]
/// Type alias for Eventsbusconfigcanonical
pub type EventsBusConfigCanonical =
    nestgate_config::config::canonical_primary::domains::network::CanonicalNetworkConfig;

// Note: Keep using EventsBusConfig (the deprecated struct) for now.
