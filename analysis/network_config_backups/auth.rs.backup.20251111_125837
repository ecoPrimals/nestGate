...
impl DefaultService {
    ...
    pub fn new(config: NetworkAuthConfig) -> Self {
        Self {
            config,
...
impl Service for DefaultService {
    ...
    fn shutdown(&self) -> impl std::future::Future<Output = Result<()>> + Send {
        ...
        tracing::info!("Shutting down {} service", stringify!(auth));
        Ok(())
        }
    }
}
...
pub fn create_service() -> DefaultService {
    DefaultService::new(NetworkAuthConfig::default())
}

/// Validate configuration
pub async fn validate_config(config: &NetworkAuthConfig) -> crate::Result<()> {
...
mod tests {
    ...
    fn test_config_validation() {
        let mut config = NetworkAuthConfig::default();
