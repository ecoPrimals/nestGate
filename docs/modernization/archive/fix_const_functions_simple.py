...
Simple approach - just replace const fn with fn for problematic signatures.
"""
...
def fix_const_functions():
    ...
    # Simple patterns to fix const functions that can't be const
    patterns_to_fix = [
        ...
        # Functions returning Result with String
        (r'pub const fn ([^(]+\([^)]*\)) -> Result<String>', r'pub fn \1 -> Result<String>'),
        (r'pub const fn ([^(]+\([^)]*\)) -> Result<\(\), String>', r'pub fn \1 -> Result<(), String>'),
        # Functions returning Option<String>
        (r'pub const fn ([^(]+\([^)]*\)) -> Option<String>', r'pub fn \1 -> Option<String>'),
        # Functions returning complex Result types
