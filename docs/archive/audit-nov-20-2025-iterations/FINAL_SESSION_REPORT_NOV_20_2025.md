...
1. **Coverage Quick Wins** (2-3 hours)
   - Add tests for `snapshot/scheduler.rs` (+200 lines)
   - Add tests for `zero_cost_zfs_operations/manager.rs` (+350 lines)
   - Add tests for `native/pool_manager.rs` (+300 lines)
   - **Expected**: +0.75% coverage (68.89% → 69.64%)
